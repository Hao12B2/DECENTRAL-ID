...
function ReqDetails() {
    ...
    return (
        <div className='flex flex-col items-center justify-center w-full h-full bg-cover bg-center' style={{ backgroundImage: "url('/bg3.jpg')" }}>
        {vreq !== null && <div className='h-[80%] w-[50%] flex flex-col justify-center items-center bg-gray-100 rounded-md'>
            ...
            <div className='flex flex-col justify-start my-10 space-y-5 w-60'>
                ...
                {vreq.dob !== "" && <h3>Date of Birth: {vreq.dob}</h3>}
                ...
                <button className='p-2 bg-yellow-300 rounded hover:bg-yellow-400' onClick={() => window.open(`https://gateway.pinata.cloud/ipfs/${vreq.cid}`, '_blank')}>
                    View File
                </button>
            </div>
